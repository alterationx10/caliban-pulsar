...
object PulsarProducerProvider {
  ...
  private val acquire: ZIO[Has[PulsarClient] with Has[PulsarProducerConfig], Throwable, Producer[String]] =
    for {
  ...
  val managed: ZManaged[Has[PulsarClient] with Has[PulsarProducerConfig], Throwable, Producer[String]] =
    ZManaged.make(acquire)(_.release)

  val layer: ZLayer[Has[PulsarClient] with Has[PulsarProducerConfig], Throwable, Has[Producer[String]]] =
